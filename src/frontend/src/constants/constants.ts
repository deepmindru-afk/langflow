...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Portflow documentation for more information on how to write your own component.";
...
export const API_PAGE_PARAGRAPH =
  "Your secret Portflow API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Portflow Chat";
...
export const STORE_TITLE = "Portflow Store";
...
export const DISCORD_URL =  "https://www.portalos.ru" //"https://discord.com/invite/EqksyE2EX9";
export const GITHUB_URL =  "https://www.portalos.ru" //"https://github.com/langflow-ai/langflow";
export const TWITTER_URL =  "https://www.portalos.ru"//"https://x.com/langflow_ai";
export const DOCS_URL =  "https://www.portalos.ru"//"https://docs.langflow.org";
export const DATASTAX_DOCS_URL =  "https://www.portalos.ru"
  //"https://docs.datastax.com/en/langflow/index.html";
export const DESKTOP_URL = "https://www.portalos.ru" //"https://www.langflow.org/desktop";
export const BUG_REPORT_URL = "https://www.portalos.ru" //"https://github.com/langflow-ai/langflow/issues";
