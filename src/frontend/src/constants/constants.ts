...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Portal flows documentation for more information on how to write your own component.";
...
export const API_PAGE_PARAGRAPH =
  "Your secret Portal flows API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Portal flows Chat";
