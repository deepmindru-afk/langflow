...
""")
    ...
    url_component.set(urls=["https://www.portalos.ru/", "https://www.portalos.ru/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Portal flows and AI. "
